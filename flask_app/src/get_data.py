...
def get_song_data(track, year, artist):
    ...
    song_data['tatums_per_second'] = [len(aa['tatums']) / (results['duration_ms'] / 60000)]
    song_data['beats_per_second'] = [len(aa['beats']) / (results['duration_ms'] / 60000)]
    song_data['bars_per_second'] = [len(aa['bars']) / (results['duration_ms'] / 60000)]
